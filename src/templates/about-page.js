...
export const AboutPageTemplate = ({ title, content, contentComponent }) => {
  ...
  return (
    <section classNameName="section section--gradient">
      <div classNameName="container">
        <div classNameName="columns">
          <div classNameName="column is-10 is-offset-1">
            <div classNameName="section">
              <h2 classNameName="title is-size-3 has-text-weight-bold is-bold-light">
                {title}
              </h2>
